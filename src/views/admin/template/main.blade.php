...
<div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('admin')}}" class="logo">
          ...
          <span class="logo-mini"><b>J</b>BG</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>JSD</b>Blog</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="{{url('https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.3/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Support Team
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{url('https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.3/img/user2-160x160.jpg')}}" class="user-image" alt="User Image">
